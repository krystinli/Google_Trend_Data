...
OPENDATA_TORONTO_CATALOG_URL = (
    "https://www.toronto.ca/ext/open_data/catalog/delivery/open_data_catalog.json")

resp = requests.get(OPENDATA_TORONTO_CATALOG_URL)

# checking status and content
resp
resp.json()

# extract csv file names from this url
